package by.paprauka.database.config;
...
@ComponentScan("by.paprauka.database")
@PropertySource({"classpath:datasource.properties", "classpath:hibernate.properties"})
@EnableTransactionManagement
@Configuration
@EnableJpaRepositories(basePackages = "by.paprauka.database.repository")
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Properties hibernateProperties) {
        ...
        entityManagerFactory.setPackagesToScan("by.paprauka.database.entity");
